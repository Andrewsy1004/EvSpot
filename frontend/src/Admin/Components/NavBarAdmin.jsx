...
import { FaCalendarAlt, FaSignOutAlt, FaUser, FaBars, FaTimes, FaClipboardList, FaPlusCircle } from 'react-icons/fa';
    ...
    return (
        <nav className="bg-gray-800 p-4">
            ...
            >
                ...
                >
                    <FaPlusCircle className="h-5 w-5 inline-block mr-2" />
                    Crear Salón
                </NavLink>
                <NavLink
                    className={({ isActive }) =>
                    ...
                    onClick={() => setIsOpen(false)}
                >
                    <FaClipboardList className="h-5 w-5 inline-block mr-2" />
                    Mis Reservas
                </NavLink>
                <NavLink
                    className={({ isActive }) =>
                ...
                >
                    {icono ? (
                        ...
                        <FaUser className="h-5 w-5 inline-block mr-1" />
                    )}
                    {nombre}
                </NavLink>
                <button
